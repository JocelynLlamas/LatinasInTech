<div>
    <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: white;">
        <div class="fluid-container d-flex flex-column" style="width: 100%;">
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row-reverse">
                        ...
                        <div class="col-auto p-2 d-flex justify-content-center align-items-center ">
                            Tiendita
                        </div>
                        <div class="col-auto p-2 d-flex justify-content-center align-items-center">
                            Blog
                        ...
                        <div class="col-auto dropdown p-2">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col mt-2 border-top border-secondary-subtle">
                        <div class="container d-flex flex-row">
                            ...
                            <div class="collapse navbar-collapse d-flex flex-row-reverse" id="navbarSupportedContent">
                                <ul class="navbar-nav mb-2 mb-lg-0 ">
                                    <li class="nav-item">
                                        <a class="nav-link" aria-current="page" href="#" style="color:black; font-weight: bold">Dashboard</a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" style="color:black; font-weight: bold">Events</a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color:black; font-weight: bold">
                                            Level up
